...
(defun sample-linear-regression ()
    (let (dataset airquality)
      (print (setf dataset 
         (read-data-from-file 
          (asdf:system-relative-pathname 'clml.extras "sample/airquality.csv")
          :type :csv
          :csv-type-spec 
...
(define-test simple-linear-regression-case
    (let* ((cars (read-data-from-file (asdf:system-relative-pathname 'clml.extras "sample/cars.csv") :type :csv :csv-type-spec '(double-float double-float)))
...
(define-test multi-linear-regression-case
    (let* ((air (read-data-from-file (asdf:system-relative-pathname 'clml.extras "sample/airquality.csv")
				     :type :csv
