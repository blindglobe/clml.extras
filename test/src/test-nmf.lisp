...
(define-test test-nmf
    (let (matrix w h sports-corpus politics-corpus)
      ...
      (setf sports-corpus
	(read-data-from-file (asdf:system-relative-pathname 'clml.extras "sample/sports-corpus-data") :external-format :utf-8))
	...
	(read-data-from-file (asdf:system-relative-pathname 'clml.extras "sample/politics-corpus-data") :external-format :utf-8))
