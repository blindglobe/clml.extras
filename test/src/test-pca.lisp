...
(define-test test-sample-pca
    (let (dataset proj-vecs pca-result pca-model for-learn for-estimate)
      (assert-true (setf dataset 
                     (read-data-from-file (asdf:system-relative-pathname 'clml.extras "sample/pos.sexp") 
      ...
      (let ((eyes (pick-and-specialize-data
                   (read-data-from-file (asdf:system-relative-pathname 'clml.extras "sample/eyes200.sexp"))
                   :except '(0)
